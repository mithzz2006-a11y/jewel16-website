    ...
    <div style={container}>
      <div style={page}>
        ...
        <div style={card}>
          ...
          {/* 📦 ORDER ID */}
          <div style={orderBox}>
            <p style={orderLabel}>Order ID</p>
            <h2 style={orderIdText}>#JEWEL{orderId}</h2>
          </div>

          {/* 🔘 BUTTONS */}
          <div style={btnWrap}>
            <button style={primaryBtn} onClick={() => setPage("orders")}>
              View Orders
            </button>
...
const page = {
  ...
  alignItems: "center",
  textAlign: "center",
  background: "linear-gradient(to bottom right, #000, #3b0000)",
  padding: "20px",
};
...
const icon = {
  ...
  height: "90px",
  borderRadius: "50%",
  background: "linear-gradient(to right, green, #00b300)",
  color: "white",
  fontSize: "42px",
  display: "flex",
  justifyContent: "center",
